...
<body>
	...
	Add this link to your bookmark: <a href="javascript:(function(D,js,css,js_url,css_url,id){
		...
		js.id <?= id + '-js';
		js.src <?= js_url;
		js.setAttribute('data-home-url','<?= $CONFIG['HOME_URL'];?>');
	...
	})(document,'#js','#css','<?= $CONFIG['HOME_URL'];?>/static/js/bookmark.js?v=<?= $CONFIG['VERSION'];?>','<?= $CONFIG['HOME_URL'];?>/static/css/bookmark.css?v=<?= $CONFIG['VERSION'];?>','spe');">屌图床Ext - Sinapic-Ext v<?= $CONFIG['VERSION'];?></a>
	</h1>
